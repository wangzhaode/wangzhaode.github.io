...
<tr class="odd">
<td style="text-align: left;"><strong>追求可在端侧运行的快速模型</strong></td>
<td style="text-align: left;"><span class="math display">→</span></td>
<td style="text-align: left;"><strong>小巧且高效的模型</strong></td>
</tr>
<tr class="even">
<td style="text-align: left;"><strong>构建强大的多语言模型</strong></td>
<td style="text-align: left;"><span class="math display">→</span></td>
<td style="text-align: left;"><strong>更大的分词器词汇表</strong></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><strong>需要超长上下文能力</strong></td>
<td style="text-align: left;"><span class="math display">→</span></td>
<td style="text-align: left;"><strong>混合型架构</strong></td>
</tr>
</table>
...
1.  **可靠性（Reliability）：** 实验应提供强大的**判别力（discriminative power）**。如果关注的指标无法在早期有意义地区分不同设置的优劣，那么实验提供的洞察就会很少。
...
1.  **经过大规模验证：** 在相似或更大的规模上，跑过**数万亿（multi-trillion）Token**的训练。
1.  **文档完善：** 有明确的、被证明有效的超参数配置。
1.  **框架支持良好：** 理想情况下，它应该被你计划使用的**训练框架**和**推理框架**所支持。
...
<td style="text-align: left;">Llama 3.1, Llama 3.2, Qwen3, Gemma3, SmolLM2, SmolLM3</td>
<td style="text-align: left;">0.6B - 70B</td>
</tr>
<tr class="even">
<td style="text-align: left;"><strong>MoE (专家混合)</strong></td>
<td style="text-align: left;">Qwen3 MoE, GPT-OSS, Kimi Moonlight, Kimi-k2, DeepSeek V3</td>
<td style="text-align: left;">16B - 1T</td>
</tr>
<tr class="odd">
<td style="text-align: left;"><strong>混合型（Hybrid）</strong></td>
<td style="text-align: left;">Zamba2, Falcon-H1</td>
<td style="text-align: left;">0.5B - 34B</td>
</tr>
<tr class="even">
<td style="text-align: left;"><strong>MoE + 混合型</strong></td>
<td style="text-align: left;">Qwen3-Next, MiniMax-01</td>
<td style="text-align: left;">80B - 456B</td>
</tr>
</table>
...
1.  **稳定性和生产就绪：** 框架需要稳定、成熟，不会在训练中途神秘地崩溃。
1.  **高吞吐量：** 它应该能提供强大的吞吐量，以便我们快速迭代。
...
<td style="text-align: left;">⚡ 持续增长</td>
<td style="text-align: left;">⚠️ 较新</td>
<td style="text-align: left;">⚡ 针对密集模型优化</td>
<td style="text-align: left;">7k / 9k</td>
<td style="text-align: left;">⚡ 适中</td>
</tr>
<tr class="even">
<td style="text-align: left;"><strong>Nanotron</strong></td>
<td style="text-align: left;">🎯 为HF预训练定制</td>
<td style="text-align: left;">✅ StarCoder, SmolLM</td>
<td style="text-align: left;">✅ 高度优化</td>
...
1.  **方法二（减小模型）：** 如果目标模型太大，我们可以训练一个**更小的代理模型**。例如，Kimi在开发其**1T参数的K2模型**时，就使用了一个**3B参数的MoE模型**来运行部分消融实验。
...
<th style="text-align: left;">GPU 数量</th>
<th style="text-align: left;">天数</th>
<th style="text-align: left;">GPU-小时</th>
</tr>
<tr class="odd">
...
<th style="text-align: left;">训练 Token</th>
<th style="text-align: left;">注意力机制</th>
<th style="text-align: left;">上下文长度</th>
...
<th style="text-align: left;">Warmup 步数</th>
...
<td style="text-align: left;">236B (21B)</td>
...
<td style="text-align: left;">Multi-Step</td>
<td style="text-align: left;">2K</td>
<td style="text-align: left;">9.4M -&gt; 37.7M</td>
</tr>
<tr class="odd">
<td style="text-align: left;">Kimi K2</td>
<td style="text-align: left;">MoE</td>
<td style="text-align: left;">1T (32B)</td>
...
<tr class="header">
<th style="text-align: left;">注意力机制</th>
<th style="text-align: left;">每个Token的KV-Cache参数量</th>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><span class="math display">2 × <em>g</em> × <em>n</em><sub><em>l</em><em>a</em><em>y</em><em>e</em><em>r</em><em>s</em></sub> × <em>d</em><em>i</em><em>m</em><sub><em>h</em><em>e</em><em>a</em><em>d</em></sub></span> (g为组数)</td>
</tr>
<tr class="even">
...
1.  **非绑定-减少层数 (1.2B):** 非绑定嵌入，但层数更少（12层）以保持参数预算。
1.  **非绑定-相同层数 (1.46B):** 非绑定嵌入，层数与基线相同（16层）。
...
它们通过重新排序计算，将注意力的复杂度从<img src="https://www.zhihu.com/equation?tex=O%28N%5E2%29" alt="O(N^2)" class="ee_img tr_noresize" eeimg="1">降低到<img src="https://www.zhihu.com/equation?tex=O%28N%29" alt="O(N)" class="ee_img tr_noresize" eeimg="1">，从而在长序列上实现显著的效率优势。Mamba、RetNet等都属于这一范畴。虽然它们显示出巨大潜力，但当扩展到大规模时，仍需考虑许多细微差别，其成熟度也不及密集型和MoE模型。
...
1.  **连续词比例:** 有多少百分比的词语被分割成多个片段。**越低越好**。
...
1.  **注意力:** GQA，分组比率为4。
1.  **位置编码:** NoPE（每隔4层移除RoPE）+ 文档内掩码。
1.  **模型布局:** 采用了更深的Qwen 2.5-3B布局。
1.  **稳定性:** 保留了绑定嵌入，并移除了嵌入层的权重衰减。
